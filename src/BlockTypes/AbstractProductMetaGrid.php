...
/**
 * AbstractProductMetaGrid class.
 */
abstract class AbstractProductMetaGrid extends AbstractDynamicBlock {
	...
	protected function get_attributes() {
		return array(
			...
			'columns'           => $this->get_schema_number( wc_get_theme_support( 'product_blocks::default_columns', 1 ) ),
			...
			'showDesc'          => $this->get_schema_boolean( false ),
			'showPrice'         => $this->get_schema_boolean( true ),
			'contentAlign'      => $this->get_schema_align(),
			'dimRatio'          => $this->get_schema_number( 70 ),
			'focalPoint'        => array(
				'type'    => 'object',
				'default' => 'any',
			),
			'editMode'          => $this->get_schema_boolean( true ),
			'mediaId'           => $this->get_schema_number( 0 ),
