...
/**
 * Register and run the "Aow Product" block.
 */
registerBlockType( 'woocommerce/aow-product', {
	title: __( 'Aow Product', 'woo-gutenberg-products-block' ),
	icon: {
		src: 'star',
		foreground: '#96588a',
	},
	...
	attributes: {
		...
		/**
		 * ID for a custom image, overriding the product's aow image.
		 */
		mediaId: {
			type: 'number',
			default: 0,
		...
		/**
		 * URL for a custom image, overriding the product's aow image.
		 */
		mediaSrc: {
			type: 'string',
			default: '',
